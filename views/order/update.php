...
<?php $form = ActiveForm::begin([
    ...
    <div class="modal-body">
        <div class="col-sm-8" style="padding-left:0px;">
            ...
            <?= $form->field($model, 'shop',['horizontalCssClasses' => ['wrapper' => 'col-sm-8']])->label('店铺',['class'=>'control-label col-sm-4'])->textInput(['readonly'=>'readonly','style'=>'width:90%;float:left;'])->hint("&nbsp;*",['style'=>'float:left;color:red;font-size:25px;'])->error(['style'=>'clear:both;']) ?>
            <?= $form->field($model, 'commodity',['horizontalCssClasses' => ['wrapper' => 'col-sm-8']])->label('ID',['class'=>'control-label col-sm-4'])->textInput(['readonly'=>'readonly','style'=>'width:90%;float:left;'])->hint("&nbsp;*",['style'=>'float:left;color:red;font-size:25px;'])->error(['style'=>'clear:both;']) ?>
            ...
            <?= $form->field($model, 'order_time',['horizontalCssClasses' => ['wrapper' => 'col-sm-8']])->label('下单时间',['class'=>'control-label col-sm-4'])->textInput(['readonly'=>'readonly','onfocus'=>Html::decode('WdatePicker({dateFmt:&quot;yyyy-MM-dd HH:mm:ss&quot;})')]) ?>
